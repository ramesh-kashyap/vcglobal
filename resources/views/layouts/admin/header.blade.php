                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ route('admin.userSummary') }}">Users Balance</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{route('admin.add-return')}}">Bot Management</a></li>
                            <li><a href="{{ route('admin.deposit-qr') }}">Deposit QR's</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('admin.team-revenue-share') }}">Team Revenue Share</a></li>

                            <li><a href="{{ route('admin.referral-revenue-share') }}">Referral Revenue Share</a></li>
                            <li><a href="{{route('admin.revenue-share')}}">Revenue Share</a></li>
                            <li><a href="{{route('admin.salary-income')}}">Salary Income</a></li>
                            <li><a href="{{route('admin.reward-income')}}">Reward Income</a></li>
                    ...
                    <li><a href="{{route('admin.withdrawalInfo')}}">Withdrawal Info</a></li>
        ...
        ***********************************-->
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                const shortLogo = document.querySelector(".short-logo");

                hamburger.addEventListener("click", function() {
                    brandLogo.classList.toggle("active");
                    shortLogo.classList.toggle("active");
                });
            });
        </script>