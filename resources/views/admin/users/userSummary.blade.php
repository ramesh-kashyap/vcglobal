            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Users Balance</a></li>
                    </ol>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Users Balance</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($alluserlist as $value)
                                                <tr>
                                                    ...
                                                    <td>{{ currency() }} {{ $value->u_credits }}</td>
                                                    <td>{{ currency() }} {{ $value->u_strategy }}</td>
                                                    <td>{{ currency() }} {{ $value->u_profit }}</td>
                                                   
        
                                                    <td>{{ currency() }} {{ $value->u_profit }}</td>
        
                                                    <td>{{ currency() }} {{ $value->u_opt }}
                                                    </td>
