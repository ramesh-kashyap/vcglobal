				...
				<div class="row">
					...
					<div class="col-xl-3 col-sm-3">
						<div class="card">
							<div class="card-body d-flex align-items-center justify-content-between">
								<div class="menu">
									<span class="font-w500 fs-16 d-block mb-2">Team Revenue Share</span>
									<h2>{{currency()}} {{  number_format((\App\Models\Income::where('remarks','Team Revenue Share')->sum('comm')),2)   }}  </h2>
								</div>
								<div class="d-inline-block position-relative donut-chart-sale">
					...
					<div class="col-xl-3 col-sm-3">
						<div class="card">
							<div class="card-body d-flex align-items-center justify-content-between">
								<div class="menu">
									<span class="font-w500 fs-16 d-block mb-2">Referral Revenue Share</span>
									<h2>{{currency()}} {{  number_format((\App\Models\Income::where('remarks','Referral Revenue Share')->sum('comm')),2)   }}   </h2>
								</div>
								<div class="d-inline-block position-relative donut-chart-sale">
					...
					<div class="col-xl-3 col-sm-3">
						<div class="card">
							<div class="card-body d-flex align-items-center justify-content-between">
								<div class="menu">
									<span class="font-w500 fs-16 d-block mb-2">Revenue Share</span>
									<h2>{{currency()}} {{  number_format((\App\Models\Income::where('remarks','Revenue Share')->sum('comm')),2)   }}  </h2>
								</div>
								<div class="d-inline-block position-relative donut-chart-sale">
