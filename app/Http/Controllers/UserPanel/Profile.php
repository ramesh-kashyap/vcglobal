...
class Profile extends Controller
{
    ...
    {
    $user=Auth::user();
    $profile_data = User::where('id',$user->id)->first();
    $name=$profile_data->name;
    $username=$profile_data->username;
    $phone=$profile_data->phone;
    $email=$profile_data->email;
    $status=$profile_data->active_status;
 ...
 public function update(Request $request)
      ...
      public function wallet_change(Request $request)
    {
        try{
         ...
         $request->validate(['usdtTrc20' => 'required','usdtBep20' => 'required']);
           
     
         $usdtTrc20 = $request->usdtTrc20;
         $usdtBep20 = $request->usdtBep20;
