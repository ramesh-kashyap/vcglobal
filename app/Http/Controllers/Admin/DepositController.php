...
class DepositController extends Controller
{
    ...
    public function depositqr(Request $request)
    {
      $notes=Depositaddress::all();  
      
        $this->data['withdraw_list'] =  $notes;
        $this->data['page'] = 'admin.deposit.deposit-qr';
        return $this->admin_dashboard();
    }
    ...
    public function updateQR(Request $request)
    {
        ...
        // Find the Depositaddress record by its ID
        $data = Depositaddress::where('d_id', $id)->first();
    
        // Check if the record exists
        if ($data) {
            // Update the d_ref field with the new value from the request
            $data->d_ref = $request->d_ref;
            ...
            // If the record with the provided ID is not found, you can return a failure response
